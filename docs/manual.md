...
ページを選択している状態では、用紙、向き、図枠、図番、図名、作成者、日付などを編集できます。
...
左パネルの「端子CSV取込」を押すと、CSV または TSV ファイルから端子接続図ページを作成できます。
...
配線には FROM/TO 推定情報、線番固定、線番非表示、配線ギャップの情報が含まれます。
...
CSV から作る場合は、左パネルの「端子CSV取込」を押してファイルを選択します。
